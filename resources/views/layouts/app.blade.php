...
<head>
    ...
    <title>Cafeteria - @yield('custom-title')</title>
    <link rel="dns-prefetch" href="//fonts.gstatic.com">
    <link rel="shortcut icon" href="{{ asset('img/logo.png') }}" type="image/x-icon">
    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Poppins:300,400,500,600,700" />
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.8.1/font/bootstrap-icons.css">
    <link rel="stylesheet" href="{{ asset('dist/assets/plugins/custom/datatables/datatables.bundle.css') }}">
    <link rel="stylesheet" href="{{ asset('dist/assets/plugins/global/plugins.bundle.css') }}">
    <link rel="stylesheet" href="{{ asset('dist/assets/css/style.bundle.css') }}">
...
<body>
        ...
        <div class="toast show" role="alert" aria-live="assertive" aria-atomic="true">
            <div class="toast-header">
                <span class="svg-icon svg-icon-2 svg-icon-primary me-3">
                    <img src="{{ asset('dist/assets/media/logo.png') }}" width="32px" height="32px">
                </span>
    ...
    @endif
    <div id="kt_header" style="background-color:#fff;" class="header align-items-stretch border pt-5 pb-5">
        ...
        <div class="container-xxl d-flex align-items-stretch justify-content-between">
            <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0 me-lg-0">
                <a href="@if(Auth::user()->role === 'admin') {{route('admin.home')}} @else {{route('home')}} @endif" class="navbar-brand fs-4">
                    {{ config('app.name') }}
                </a>
            </div>
                    ...
                    <div class="header-menu align-items-stretch" data-kt-drawer="true" data-kt-drawer-name="header-menu" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '300px': '250px'}" data-kt-drawer-direction="end" data-kt-drawer-toggle="#kt_header_menu_mobile_toggle" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_body', lg: '#kt_header_nav'}" style="">
                        <div class="menu menu-lg-rounded menu-column menu-lg-row menu-state-bg menu-title-gray-700 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-400 fw-bold my-5 my-lg-0 align-items-stretch" id="#kt_header_menu" data-kt-menu="true">
                            <div class="menu-item me-lg-1">
                                <a class="menu-link py-3" href="@if(Auth::user()->role === 'admin') {{route('admin.home')}} @else {{route('home')}} @endif">
                                    <span class="menu-title">Dashboard</span>
                                </a>
                            </div>
                            @if(Auth::user()->role === 'customer')
                            <div class="menu-item me-lg-1">
                                <a class="menu-link py-3" href="{{ route('offer.index') }}">
                    ...
                    <div class="d-flex align-items-stretch flex-shrink-0">
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane fade show active" id="kt_topbar_notifications_1" role="tabpanel">
                                        <div class="scroll-y mh-325px my-5 px-8">
                                            ...
                                            <div class="d-flex flex-stack py-4">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="mb-0 me-2">
                                                        <a class="fs-6 text-gray-800 text-hover-primary fw-bolder">No New Notification!</a>
                                                    </div>
                                                </div>
                                            </div>
                                            @endif
                                            @if(auth()->user()->unreadnotifications->count() > 0)
                                                ...
                                                <div class="d-flex flex-stack py-4">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="mb-0 me-2">
                                                            <a href="@if(Auth::user()->role === 'customer') {{ $notification->data['link'] }} @else # @endif" class="fs-6 text-gray-800 text-hover-primary fw-bolder">{{ $notification->data['info'] }}</a>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="py-3 text-center border-top">
                                            <a href="@if(Auth::user()->role ===  'customer') {{ route('markRead') }} @else {{ route('admin.markRead') }} @endif" class="btn btn-color-gray-600 btn-active-color-primary">Mark All
                                        ...
                                        <div class="scroll-y mh-325px my-5 px-8">
                                            ...
                                            <div class="d-flex flex-stack py-4">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="mb-0 me-2">
                                                        <a href="#" class="fs-6 text-gray-800 text-hover-primary fw-bolder"><del>{{ $notification->data['info'] }}</del></a>
                                                    </div>
                                                </div>
                                                <span class="badge badge-light fs-8">{{ Carbon\Carbon::parse($notification->read_at)->diffForHumans() }}</span>
                                            </div>
                                            @endforeach
                                        </div>
                                    </div>
                        ...
                        <div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                            <div class="cursor-pointer symbol symbol-30px symbol-md-40px" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                                <img alt="avatar" src="../../img/user/{{ Auth::user()->avatar }}">
                            </div>
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px" data-kt-menu="true" style="">
                                ...
                                <div class="menu-item px-5">
                                    <a href="@if(Auth::user()->role === 'admin') {{ route('admin.profile.show', Auth::user()->id) }} @else {{ route('profile.show', Auth::user()->id) }} @endif" class="menu-link px-5">My Profile</a>
                                </div>
                                <div class="menu-item px-5">
    ...
    <div class="content d-flex flex-column flex-column-fluid">
        <div class="container-xxl card pt-5 pb-5 mb-5 col-md-10 card-body shadow-sm">
            @yield('content')
        </div>
    </div>
</body>
    <script type="text/javascript" src="{{ asset('dist/assets/plugins/global/plugins.bundle.js') }}"></script>
    <script type="text/javascript" src="{{ asset('dist/assets/js/scripts.bundle.js') }}"></script>
    <script type="text/javascript" src="{{ asset('dist/assets/plugins/custom/datatables/datatables.bundle.js') }}"></script>
    <script type="text/javascript" src="{{ asset('dist/assets/js/custom/pages/projects/list/list.js') }}"></script>
	<script type="text/javascript" src="{{ asset('dist/assets/js/custom/pages/projects/users/users.js') }}"></script>
